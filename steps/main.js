...
const assistant = await openai.beta.assistants.create({ instructions: 'You are a friendly bot.', model: 'gpt-4-1106-preview' });
//console.log(JSON.stringify(assistant, null, 2));

const thread = await openai.beta.threads.create();
//console.log(JSON.stringify(thread, null, 2));

const message = await openai.beta.threads.messages.create(thread.id, { role: 'user', content: 'hi' });
